...
function ProductItem(product: Product) {
   ...
   return (
      <div className="w-full md:w-1/3 lg:w-1/4 p-4 bg-white m-2 rounded-lg shadow-sm">
         <p className='uppercase p-2 rounded-xl bg-pink-100 w-fit text-sm font-bold'>{product.category}</p>
         <h3 className='uppercase rounded-xl text-xl font-bold'>{product.name}</h3>
         <h4 className='uppercase p-2 rounded-xl text-pink-500 w-fit text-3xl font-bold'>${product.price}</h4>
